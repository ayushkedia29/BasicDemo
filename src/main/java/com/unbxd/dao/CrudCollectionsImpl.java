...
public class CrudCollectionsImpl implements dao.CrudCollections {
    ...
    @Override
    public Student readCollection(MongoCollection collection, Integer id) {
    ...
    @Override
    public void updateCollection(MongoCollection collection, Integer id) {
    ...
    @Override
    public long deleteCollection(MongoCollection collection, Integer id) {
